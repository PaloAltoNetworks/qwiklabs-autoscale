...
def GenerateConfig(context):
    ...
    app_trust_vpc_project, trust_subnet = context.properties['trust-subnet'].split('/')
                ...
                'properties': {
                    ...
                    'networkInterfaces': [
                        {'network': ''.join([COMPUTE_URL_BASE, 'projects/',
                                 app_trust_vpc_project,'/global/',
                                 'networks/', trust_network]),
                        'subnetwork': ''.join([COMPUTE_URL_BASE, 'projects/',
                                 app_trust_vpc_project,'/regions/', context.properties['region'],
                                 '/subnetworks/', trust_subnet])
                        #'accessConfigs': [{
                        #    'name': 'External NAT',
                        #    'type': 'ONE_TO_ONE_NAT'}]
                        }
